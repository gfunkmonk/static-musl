...
sed -i 's/CFLAGS=-O3 -Wall -Wextra -Wno-unknown-pragmas -Wcast-qual/CFLAGS=${BASE_CFLAGS} ${ARCH_FLAGS} ${EXTRA_CFLAGS} ${LTOFLAGS}/g' Makefile
sed -i 's/LDFLAGS=/LDFLAGS=${BASE_LDFLAGS} -w -Wl,-s/g' Makefile
