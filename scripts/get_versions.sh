...
BAT_VER=${GREEN}$(get_version release "sharkdp/bat" '.tag_name | ltrimstr("v")' "${RED}FALLBACK${NC}")
echo -e "${BWHITE}bat: ${BAT_VER}${NC}"
...
ENVX_VER=${GREEN}$(get_version release "mikeleppane/envx" '.tag_name | ltrimstr("v")' "${RED}FALLBACK${NC}")
echo -e "${BWHITE}envx: ${ENVX_VER}${NC}"
