...
cmake -G Ninja \
  -DCMAKE_EXE_LINKER_FLAGS='${BASE_LDFLAGS} -w -Wl,-s' \
  -DCMAKE_C_FLAGS_RELEASE='${BASE_CFLAGS} ${ARCH_FLAGS} ${EXTRA_CFLAGS} ${LTOFLAGS}' \
  -DCMAKE_CXX_FLAGS_RELEASE='${BASE_CFLAGS} ${ARCH_FLAGS} ${EXTRA_CFLAGS} ${LTOFLAGS}' \
