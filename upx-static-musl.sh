...
cmake -G Ninja \
  -DCMAKE_EXE_LINKER_FLAGS='${BLDFLAGS} ${MOLD} ${NOPIE}' \
  -DCMAKE_C_FLAGS_RELEASE='${BCFLAGS} ${ARCH_FLAGS} ${EXTRA} ${LTO} ${NOPIE}' \
  -DCMAKE_CXX_FLAGS_RELEASE='${BCFLAGS} ${ARCH_FLAGS} ${EXTRA} ${LTO} ${NOPIE}' \
